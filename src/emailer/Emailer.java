...
public class Emailer {
    ...
    private static Credential authorize() throws IOException {
        // Load client secrets.
        InputStream in =
                Emailer.class.getResourceAsStream("/emailer/client_secret.json");
    ...
    public static void sendEmail(String to, String subject, String bodyText) {
        try {
            sendMessage(getGmailService(), "me", createEmail(to, "austinzhang1018@gmail.com", subject, bodyText));
        } catch (MessagingException e) {
            System.out.println("GOOGLE API NOT WORKING");
            e.printStackTrace();
        } catch (IOException e) {
            System.out.println("GOOGLE API NOT WORKING");
            e.printStackTrace();
